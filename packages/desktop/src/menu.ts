    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/michaelegbo/opencode#readme"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/michaelegbo/opencode/issues"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/michaelegbo/opencode/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/michaelegbo/opencode/issues/new?template=bug_report.yml"),
