export const dict = {
  ...
  "desktop.menu.app": "Paddie Studio",
  ...
  "desktop.menu.help.documentation": "Fork README",
  "desktop.menu.help.supportForum": "Project Issues",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Paddie Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Paddie Studio has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "Paddie Studio CLI binary is missing. Try reinstalling the desktop app.",
